...
class TocMachine(GraphMachine):
    ...
    def is_going_to_state1(self, event, reply):
        text = event.message.text
        return text.lower() == "go to state1"

    def is_going_to_state2(self, event, reply):
        text = event.message.text
        return text.lower() == "go to state2"

    def on_enter_state1(self, event, reply):
    ...
    def on_enter_state2(self, event, reply):
